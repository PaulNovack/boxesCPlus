...
OUTPUT_PATH=${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/boxescplus
OUTPUT_BASENAME=boxescplus
PACKAGE_TOP_DIR=boxescplus/
...
# Generate tar file
cd "${TOP}"
rm -f ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/boxescplus.tar
cd ${NBTMPDIR}
tar -vcf ../../../../${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/package/boxescplus.tar *
checkReturnCode
